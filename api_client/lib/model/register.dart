...
class Register {
  ...
  static Register? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'username'), 'Required key "Register[username]" is missing from JSON.');
        assert(json[r'username'] != null, 'Required key "Register[username]" has a null value in JSON.');
        assert(json.containsKey(r'password'), 'Required key "Register[password]" is missing from JSON.');
        assert(json[r'password'] != null, 'Required key "Register[password]" has a null value in JSON.');
        return true;
      }());
